...
export class PacientesEntity{    
    ...
    @Column({type:'varchar',length: 30,name: 'TipoDocumento',nullable: false}) 
    tipoDocumento: string;
    
    @Column({type:'varchar',length: 20,name: 'NumeroDocumento',nullable: false, unique: true}) 
    ...
    @Column({type:'datetime', name: 'Fecha Alta Paciente', default:()=> 'CURRENT_TIMESTAMP'})
