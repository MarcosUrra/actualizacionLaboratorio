import { Controller, Get, Param, Body, Post, Delete, Put, HttpException, HttpStatus, Patch } from '@nestjs/common';
...
export class PacientesController {
    ...
    async nuevoPaciente(@Body() nuevoPaciente: CreatePacienteDto): Promise<any> {
        ...
        if (errors.length > 0) {
          const errorMessage = 'Error al intentar cargar un nuevo paciente, todos los campos obligatorios';
