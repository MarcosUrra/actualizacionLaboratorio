...
export class MedicosController {
    ...
    @Post() 
    async crearMedico(@Body(new ValidationPipe()) nuevoMedico: crearMedicoDto): Promise<{ mensaje: string, medico: MedicosEntity }> {
    ...
    @Patch(':id')
    modificarMedico(@Param('id') id: number, @Body() medicoDto: modificarMedicoDto) {
